...
import { Award, CheckCircle2, ExternalLink, FileCheck, Shield, Building } from 'lucide-react';
      ...
      <div className="container-custom relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            نحمل جميع التراخيص والشهادات اللازمة لممارسة أعمال المقاولات في المملكة العربية السعودية
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {certificates.map((cert, index) => (
            <div
              key={cert.id}
              className={`group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover-lift border border-gray-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            ...
            >
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-gray-900" dir="ltr">{cert.number}</span>
                </div>
                <div className="flex justify-between text-sm">
