    ...
    <div className="grid lg:grid-cols-2">
      ...
      <div className="p-6 sm:p-8 flex flex-col justify-center text-right">
        <h2 className="text-2xl sm:text-3xl font-extrabold text-white">
          شاهد دراسة حالة حقيقية لمشروع تشطيب وتجديد فيلا بالرياض
        </h2>

        <p className="mt-3 text-white/75 leading-relaxed">
          صفحة واحدة مرتبة فيها مراحل التنفيذ بالصور: هدم وإعادة تشكيل، تجهيزات،
          تشطيبات داخلية وخارجية، ثم النتيجة النهائية. إذا بدك تحكم على الجودة
          قبل ما تتواصل — هاي أفضل مرجع.
        </p>
