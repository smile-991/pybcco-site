    ...
    >
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {/* Contact Info */}
          <div className={`lg:col-span-1 transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
...
>
  {info.subValue}
                      ...
                      {info.href && (
                        ...
                        >
                          {info.href.startsWith('tel') ? 'اتصل الآن' : info.href.startsWith('mailto') ? 'أرسل بريد' : 'عرض على الخريطة'}
                        </a>
                      )}
                    </div>
                  </div>
