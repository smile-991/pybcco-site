...
import VideosLibraryPage from "./sections/VideosLibraryPage";
...
/>
          ...
          <Route path="/engineering-insights/choose-contractor" element={<EngineeringInsightsChooseContractorPage />} />
          <Route path="/engineering-insights/construction-and-finishing-stages" element={<ConstructionAndFinishingStagesPage />} />
          <Route path="/engineering-insights/common-mistakes" element={<CommonMistakesPage />} />
          <Route path="/engineering-insights/cost" element={<EngineeringInsightsCostPage />} />

          {/* Choose Contractor */}

          <Route path="/engineering-insights/how-to-choose-construction-company-riyadh" element={<HowToChooseConstructionCompanyRiyadh />} />
          <Route path="/engineering-insights/top-10-questions-before-hiring-construction-company" element={<Top10QuestionsBeforeHiringConstructionCompany />} />
          <Route path="/engineering-insights/difference-between-general-contractor-and-finishing-contractor" element={<DifferenceBetweenGeneralContractorAndFinishingContractor />} />
          <Route path="/engineering-insights/how-to-verify-construction-company-quality-before-signing" element={<HowToVerifyConstructionCompanyQualityBeforeSigning />} />
          <Route path="/engineering-insights/signs-of-unprofessional-construction-company" element={<SignsOfUnprofessionalConstructionCompany />} />
          <Route path="/engineering-insights/is-it-better-to-hire-one-construction-company-or-multiple-contractors" element={<IsItBetterToHireOneConstructionCompanyOrMultipleContractors />} />
          <Route path="/engineering-insights/how-to-read-construction-quotation-properly" element={<HowToReadConstructionQuotationProperly />} />
          <Route path="/engineering-insights/common-mistakes-when-hiring-construction-company-riyadh" element={<CommonMistakesWhenHiringConstructionCompanyRiyadh />} />
          <Route path="/engineering-insights/what-should-clear-construction-contract-include" element={<WhatShouldClearConstructionContractInclude />} />
          <Route path="/engineering-insights/how-to-compare-two-construction-companies-before-decision" element={<HowToCompareTwoConstructionCompaniesBeforeDecision />} />
          <Route path="/engineering-insights/when-low-construction-price-becomes-red-flag" element={<WhenLowConstructionPriceBecomesRedFlag />} />

          {/* Construction Stages */}

          <Route path="/engineering-insights/construction-and-finishing-stages/villa-construction-stages-saudi-arabia" element={<VillaConstructionStagesSaudiArabia />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/interior-finishing-stages-villas" element={<InteriorFinishingStagesVillas />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/how-long-does-it-take-to-build-villa-riyadh" element={<HowLongDoesItTakeToBuildVillaRiyadh />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/construction-stage-inspection-checklist" element={<ConstructionStageInspectionChecklist />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/structural-shell-construction-stages" element={<StructuralShellConstructionStages />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/common-finishing-sequence-mistakes" element={<CommonFinishingSequenceMistakes />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/when-to-start-finishing-after-structure" element={<WhenToStartFinishingAfterStructure />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/difference-between-shell-and-finishing" element={<DifferenceBetweenShellAndFinishing />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/villa-construction-execution-schedule" element={<VillaConstructionExecutionSchedule />} />
          <Route path="/engineering-insights/construction-and-finishing-stages/how-to-monitor-finishing-quality" element={<HowToMonitorFinishingQuality />} />

          {/* Common Mistakes */}

          <Route path="/engineering-insights/common-mistakes/mistakes-choosing-contractor-riyadh" element={<MistakesChoosingContractorRiyadh />} />
          <Route path="/engineering-insights/common-mistakes/mistakes-comparing-quotations" element={<MistakesComparingQuotations />} />
          <Route path="/engineering-insights/common-mistakes/mistakes-finishing-contract" element={<MistakesFinishingContract />} />
          <Route path="/engineering-insights/common-mistakes/plumbing-mistakes-before-closing-walls" element={<PlumbingMistakesBeforeClosingWalls />} />
          <Route path="/engineering-insights/common-mistakes/electrical-mistakes-before-finishing" element={<ElectricalMistakesBeforeFinishing />} />
          <Route path="/engineering-insights/common-mistakes/waterproofing-and-insulation-mistakes" element={<WaterproofingAndInsulationMistakes />} />
          ...
          <Route path="/engineering-insights/cost/villa-finishing-cost-riyadh" element={<VillaFinishingCostRiyadh />} />
          <Route path="/engineering-insights/cost/finishing-price-per-meter-riyadh" element={<FinishingPricePerMeterRiyadh />} />
          <Route path="/engineering-insights/cost/turnkey-finishing-riyadh" element={<TurnkeyFinishingRiyadh />} />
          <Route path="/engineering-insights/cost/villa-construction-cost-riyadh" element={<VillaConstructionCostRiyadh />} />
          <Route path="/engineering-insights/cost/villa-300m-construction-cost-riyadh" element={<Villa300mConstructionCostRiyadh />} />
          <Route path="/engineering-insights/cost/gray-structure-cost-riyadh" element={<GrayStructureCostRiyadh />} />
          <Route path="/engineering-insights/cost/villa-shell-to-finish-cost-riyadh" element={<VillaShellToFinishCostRiyadh />} />
          <Route path="/engineering-insights/cost/apartment-finishing-cost-riyadh" element={<ApartmentFinishingCostRiyadh />} />
          <Route path="/engineering-insights/cost/economy-vs-standard-vs-luxury-finishing" element={<EconomyVsStandardVsLuxuryFinishing />} />
          <Route path="/engineering-insights/cost/what-increases-finishing-cost-riyadh" element={<WhatIncreasesFinishingCostRiyadh />} />
          <Route path="/engineering-insights/cost/plumbing-and-electrical-cost-finishing" element={<PlumbingAndElectricalCostFinishing />} />
