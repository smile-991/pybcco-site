      ...
      <div className="container mx-auto px-4">
        <article className="max-w-4xl">
          ...
          <p className="mt-3 leading-relaxed opacity-90">
            ...
            النطاق أضيق. لذلك الرقم وحده لا يكفي لفهم الفرق.
          </p>
          ...
          <p className="mt-4 leading-relaxed opacity-90">
            ...
            مرحلة لها منطق مختلف في الحساب والتسعير.
          </p>
          ...
          <p className="mt-4 leading-relaxed opacity-90">
            ...
            ذهنك كمؤشر أولي، لا كقيمة نهائية ثابتة.
          </p>
          ...
          <p className="mt-4 leading-relaxed opacity-90">
            ...
            <strong>وضوح التخطيط من البداية</strong>.
          </p>
          ...
          <p className="mt-4 leading-relaxed opacity-90">
            ...
            ناتجًا عن فرق حقيقي في النطاق أو الوضوح أو التنظيم.
          </p>
          ...
          <p className="mt-4 leading-relaxed opacity-90">
            ...
            استقرارًا وقلّت احتمالات المفاجآت أثناء التنفيذ.
          </p>
