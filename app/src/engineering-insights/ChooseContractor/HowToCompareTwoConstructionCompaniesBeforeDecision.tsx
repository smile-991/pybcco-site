...
const CANONICAL = "https://pybcco.com/engineering-insights/how-to-compare-two-construction-companies-before-decision";

const TITLE = "كيف تقارن بين شركتين مقاولات قبل اتخاذ القرار؟ دليل عملي للمقارنة الصحيحة | بنيان الهرم للمقاولات";

const DESCRIPTION = "تعرف على الطريقة الصحيحة للمقارنة بين شركتين مقاولات قبل التعاقد، وكيف تقيّم السعر والنطاق والجودة والإشراف والجدول الزمني والعقد قبل اتخاذ القرار النهائي.";
