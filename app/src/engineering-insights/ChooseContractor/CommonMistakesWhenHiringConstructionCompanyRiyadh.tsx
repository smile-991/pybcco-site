...
const CANONICAL = "https://pybcco.com/engineering-insights/common-mistakes-when-hiring-construction-company-riyadh";

const TITLE = "أخطاء شائعة عند التعاقد مع شركة مقاولات في الرياض | دليل عملي قبل التوقيع | بنيان الهرم للمقاولات";

const DESCRIPTION = "تعرف على أهم الأخطاء الشائعة عند التعاقد مع شركة مقاولات في الرياض، وكيف تتجنب مشاكل السعر والنطاق والدفعات والتعديلات والإشراف قبل بدء المشروع.";
