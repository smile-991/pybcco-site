...
const CANONICAL = "https://pybcco.com/engineering-insights/comparisons-options/gypsum-board-vs-cement-board-wet-areas";

const TITLE =
  "الجبس بورد أم الأسمنت بورد: ما الأفضل في الحمامات والمطابخ؟ | بنيان الهرم للمقاولات";

const DESCRIPTION =
  "مقارنة عملية بين الجبس بورد والأسمنت بورد في الحمامات والمطابخ من حيث تحمل الرطوبة، الاستخدام الصحيح، التكلفة، والعمر التشغيلي لمساعدة المالك على اختيار النظام الأنسب.";
